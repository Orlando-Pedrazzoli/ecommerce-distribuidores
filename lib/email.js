...
// DISTRIBUIDOR: Preço total + royalties detalhados
...
// MOSTRA: Preço total + royalties detalhados
// ══════════════════════════════════════════════════════════════
        ...
        <div class="total">
          ...
          <table style="width: 100%;">
            <tr>
              ...
              <td style="padding: 8px 0; text-align: right; font-weight: bold;">R$ ${subtotalProdutos.toFixed(2)}</td>
            </tr>
            <tr>
              <td style="padding: 8px 0; color: #666;">Taxa de Serviço (5%):</td>
              <td style="padding: 8px 0; text-align: right; color: #666;">R$ ${pedido.royalties.toFixed(2)}</td>
            </tr>
    ...
    <body>
      <div class="container">
        ...
        <div style="display: flex; gap: 10px; margin-bottom: 15px;">
          <div style="flex: 1; background: #e3f2fd; padding: 12px; border-radius: 8px;">
            <strong>👤 Distribuidor</strong><br>
            ${distribuidor.nome}<br>
            <span style="font-size: 12px; color: #666;">${distribuidor.email}</span>
          </div>
          <div style="flex: 1; background: #e8f5e9; padding: 12px; border-radius: 8px;">
            <strong>🏭 Fornecedor</strong><br>
            ${fornecedor.nome}<br>
            <span style="font-size: 12px; color: #666;">${fornecedor.codigo}</span>
          </div>
        </div>
        ...
        <div class="financial">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr style="background: #fff;">
              ...
              <td style="padding: 10px; border-bottom: 1px solid #ddd; text-align: center; color: #666;">→ Fornecedor</td>
            </tr>
...
export const enviarEmailsPedido = async (pedido, fornecedor, distribuidor) => {
  try {
    ...
    const emailsEnvio = [
      ...
      // 3. DISTRIBUIDOR - Template com totais
      {
